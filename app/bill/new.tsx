...
export default function NewBillScreen() {
  ...
  async function pickAndScan(source: 'camera' | 'library') {
    ...
    // Store image for scan screen
    setField('description', ''); // clear
  ...
  return (
    <Screen header={{ title: 'New bill', showBack: true }}>
      <Text style={[theme.typography.body, { color: theme.colors.text.secondary, marginBottom: 32 }]}>
